...
Route::group(['middleware' => ['install']], function () {
	...
	Route::get('/academy', 'Website\WebsiteController@academy');
	Route::get('/log-in', 'Website\WebsiteController@log');
	Route::get('/media', 'Website\WebsiteController@media');
	Route::get('/outdoor-team', 'Website\WebsiteController@outdoorteam');
	Route::get('/privacy-policy', 'Website\WebsiteController@privacypolicy');
	Route::get('/pro-indoor-team', 'Website\WebsiteController@proindoorteam');
	Route::get('/schedule', 'Website\WebsiteController@schedule');
	Route::get('/sponsord', 'Website\WebsiteController@sponsord');
	Route::get('/team', 'Website\WebsiteController@team');
	Route::get('/terms-condition', 'Website\WebsiteController@termscondition');
	Route::get('/tickets', 'Website\WebsiteController@tickets');
	...
	Route::delete('gallery/{blogs}', [GalleryController::class, 'delete'])->name('gallery.delete');
