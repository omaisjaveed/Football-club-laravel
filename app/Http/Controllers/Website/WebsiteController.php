...
class WebsiteController extends Controller
{
    ...
    {
        $this->theme = env('ACTIVE_THEME', 'certified_lions');
    ...
    public function Home()
    {
        ...
        return view("theme.$this->theme.index", compact('categories', 'allProducts'));
    }
    public function AboutUs()
    {
        return view("theme.$this->theme.about-us");
    }
    public function academy()
    {
        return view("theme.$this->theme.academy");
    }
    public function log()
    {
        return view("theme.$this->theme.log-in");
    }
    public function media()
    {
        return view("theme.$this->theme.media");
    }
    public function outdoorteam()
    {
        return view("theme.$this->theme.outdoor-team");
    }
    public function privacypolicy()
    {
        return view("theme.$this->theme.privacy-policy");
    }
    public function proindoorteam()
    {
        return view("theme.$this->theme.pro-indoor-team");
    }
    public function schedule()
    {
        return view("theme.$this->theme.schedule");
    }
    public function sponsord()
    {
        return view("theme.$this->theme.sponsord");
    }
    public function team()
    {
        return view("theme.$this->theme.team");
    }
    public function termscondition()
    {
        return view("theme.$this->theme.terms-condition");
    }
    public function tickets()
    {
        return view("theme.$this->theme.tickets");
    }
