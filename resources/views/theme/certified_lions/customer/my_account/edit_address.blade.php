									...
									<div class="row">
										...
										<div class="col-md-12">
											<textarea
												...
												name="address" placeholder="{{ _lang('Address') }}"
										...
										<div class="col-md-6">
											<select class="form-control" name="is_default" required>
												...
												<option value="0" {{ $address->is_default == 0 ? 'selected' : '' }}>
													{{ _lang('No') }}</option>
												<option value="1" {{ $address->is_default == 1 ? 'selected' : '' }}>
													{{ _lang('Yes') }}</option>
											</select>
										...
										<div class="col-md-12">
											<button type="submit"
												class="btn-login">{{ _lang('Update Changes') }}</button>
										</div>
									</div>
								</form>
							</div>
