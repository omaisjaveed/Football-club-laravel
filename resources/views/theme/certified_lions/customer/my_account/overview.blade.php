			...
			<div class="col-lg-9 col-md-8">
				<div class="dashboard_content">
					<div class="card">
						...
						<div class="card-body">
							<div class="form-group"><i class="fa fa-user"></i> {{ _lang('Name') }}:
								<strong>{{ Auth::user()->name }}</strong></div>
							<div class="form-group"><i class="fa fa-envelope"></i> {{ _lang('Email') }}:
								<strong>{{ Auth::user()->email }}</strong></div>
							<div class="form-group"><i class="fa fa-phone"></i> {{ _lang('Phone') }}:
								<strong>{{ Auth::user()->phone }}</strong></div>
						</div>
					</div>
				</div>
			</div>
