...
<li><a href="{{ route('gallery.index') }}"><i class="ti-menu"></i> <span>{{ _lang('Gallery') }}</span></a></li>
...
<li>
	<a href="{{ route('theme_option.update','home_page_settings') }}"><i class="ti-desktop"></i><span>{{ _lang('Website CMS') }}</span></a>
</li>
